...
date: "Placeholder for reportDate"
output: 
...
DisplayOverviewEpidTable(epid_data = epid_base)
```
...
```{r DeathCountBarplots, fig.height=8, fig.cap="Death counts"}
...
DisplayRegionEpidTable(epid_data = epid_base)
```
