...
delay = 600 # number of days to count backward from today for entities without specific delay parameters,  default = 90 days in the past
event_delay = 600 # delay for events
...
delay_default_UI = 600 # This value should be changed to say 14 on production servers
